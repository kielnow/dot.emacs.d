...
(use-package ace-jump-mode
  ...
  (loop for c from ?0 to ?9 do (my/-define-key-to-ace-jump-mode "C-" c non-convert-map))
  (loop for c from ?a to ?z do (my/-define-key-to-ace-jump-mode "C-" c non-convert-map))
  (loop for c from ?! to ?~ do (my/-define-key-to-ace-jump-mode "C-" c non-convert-map))
  (loop for c from ?0 to ?9 do (my/-define-key-to-ace-jump-mode "" c non-convert-map t))
  (loop for c from ?a to ?z do (my/-define-key-to-ace-jump-mode "" c non-convert-map t))
  (loop for c from ?! to ?~ do (my/-define-key-to-ace-jump-mode "" c non-convert-map t)))
